...
R=chol(W);
addpath('/home/iiit/shrutimoy.das/BundleAdjustment/code/bundle/cameramodel');
...
Hs = JTJ+lambda*I;
lambda
%fprintf("\nThe no of non zeros is : %d\n",nnz(Hs));
%fprintf("\nLM : The size of Hs is : %d x %d\n",size(Hs,1),size(Hs,2));
%fprintf("\nLM : The size of JTr is : %d x %d\n",size(JTr,1),size(JTr,2));
spy(Hs);
saveas(gcf,"\home\iiit\shrutimoy.das\BundleAdjustment\Hessian.png");
mat_dump_coo(Hs(1:1442,1:1442),'Hcc');
%spy(Hs(354:79316,1:353));
mat_dump_coo(Hs(1443:55421,1:1442),'Hcs');
%spy(Hs(1:353,354:79316));
mat_dump_coo(Hs(1:1442,1443:55421),'Hsc');
%spy(Hs(354:79316,354:79316));
mat_dump_coo(Hs(1443:55421,1443:55421),'Hss');
%saveas(gcf,"\home\iiit\shrutimoy.das\BundleAdjustment\Hessian.png");
mat_dump_coo(JTr,'b');
